...
//validation for name	
	...
	{	
		...
		//alert(""+charat);
		 ...
		 {
			document.getElementById("uname").innerHTML="<br/><font color=red>Name must be not start with number</font>";
			return false;
		 }
		else if(c.length < 5 )
		{
			document.getElementById("uname").innerHTML="<br/><font color=red>Name must be atleast 5 - 32 char long</font>";
			return false;
		}
