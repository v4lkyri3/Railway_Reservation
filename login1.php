...
<body>
	...
	<div class="wrap">
		...
		<div  class=" well login">
			...
			<td style="border-top:0px;"> <input type="text" name="uname" class="input-block-level" placeholder="Username"></td>
			</tr>
			<tr >
			...
			<tr>
			<td colspan="2" style="border-top:0px;"> <p>  You haven't registered ?</p></td>
			</tr>
			<tr>
			<td style="border-top:0px;"></td>
