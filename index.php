...
<head>
	...
	<link rel="shortcut icon" href="images/profile.png"></link>
	<meta charset="utf-8">
	...
	<div class="wrap">
		...
		<div class="span12 well">
			...
			<div id="myCarousel" class="carousel slide" style="width:600px; float:left;margin-bottom:3px;">		
				...
				<div class="active item"><img src="images/first.jpg" style="width:600px;height:350px;"/></div>
				<div class="item"><img src="images/second.png" style="width:600px;height:350px;"/> </div>
			...
			<marquee behavior="scroll" id="marq"  scrollamount=3 direction="up" height="294px" onmouseover="nestop()" onmouseout="nestrt()">
				<div>
				<p><b>The Railway ministry has posted the rate list on its Twitter account while asking people to lodge a complaint if they are overcharged.</b></p>
				</br>
				<p><b>Search trains between two destinations and plan your trip conveniently.</b></p>
